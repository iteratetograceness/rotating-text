...
// `framer-motion`, on commits that still import it) resolve from its
// node_modules, and `rotating-text-under-test` is its src/index.tsx. react-dom is swapped for its profiling build so the
