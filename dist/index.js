...
var FlapBoard = function FlapBoard(_ref5) {
  ...
  var _React$useState5 = React.useState(letters.length),
  ...
  var _React$useState8 = React.useState(0),
    hovered = _React$useState8[0],
    setHovered = _React$useState8[1];
  var started = React.useRef(0);
  useIsomorphicLayoutEffect(function () {
    startRef.current = function () {
...
var FlapTile = React.memo(function FlapTile(_ref6) {
  ...
  var rendered = React.useRef(faces);
  ...
  var painted = React.useRef(0);
  var _React$useState0 = React.useState(function () {
      return new Map();
    }),
